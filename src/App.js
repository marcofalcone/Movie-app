...
const App = (props) => {
  ...
  const getSearch = async () => {
    const urlMostPopular = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1";

    const urlSearch = `https://api.themoviedb.org/3/search/movie?api_key={place here your apikey}&query=${search}`;
  ...
  const getGenres = async () => {
    ...
    const urlAction = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=28&sort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";

    const urlComedy = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=35&ssort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";

    const urlHorror = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=27&sort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";

    const urlRomance = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=10749&sort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";

    const urlScifi = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=878&sort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";

    const urlThriller = "https://api.themoviedb.org/3/discover/movie?api_key={place here your apikey}&with_genres=53&sort_by=popularity.desc&language=en-US&include_adult=false&include_video=false&page=1%22";
